...
inline void sortStringArray(char **stringsArray, int stringsNumber)
{
...
inline int getRandomNumber(int rangeMin, int rangeMax)
{
    return rangeMin + rand() % (rangeMax - rangeMin + 1);
}

inline int getRandomSymbol()
{
    return getRandomNumber(SPACE_SYMBOL_CODE, TILDA_SYMBOL_CODE);
}

inline bool getAndValidateIsManualInput()
{
...
inline int getAndValidateSymbolsInString()
{
...
inline int getAndValidateStringsNumber()
{
    int stringsNumber = 0;
...
inline void printResults(int stringsNumber, char **strings)
{
    printf("\nYour array:\n");
...
inline void getStringsByKeyboard(int stringsNumber, char **strings, int symbolsInStringNumber)
{
...
inline void getGeneratedSymbols(int stringsNumber, char **strings, int symbolsInStringNumber)
{
    srand(time(NULL));
...
inline void getStrings(bool isManualInput, int stringsNumber, char **strings, int symbolsInStringNumber)
{
    if (isManualInput)
    {
...
inline char **allocateStringArray(int stringsNumber)
{
...
inline char **allocateMemoryForStrings(int stringsNumber, int symbolsInStringNumber)
{
